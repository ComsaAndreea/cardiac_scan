...
MODEL_LV_PATH = PROJECT_ROOT / "model_lv_mnm_attention.pth"
MODEL_RV_PATH = PROJECT_ROOT / "model_rv_mnm_attention.pth"
...
def train_model(X, Y, model_path, target_name):
    ...
    print("\n==============================")
    print(f"MNM ATTENTION U-NET TRAINING - {target_name}")
    print("==============================")
